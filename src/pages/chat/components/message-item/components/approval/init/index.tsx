...
type ApprovalInitMessageProps = {
  type: ApprovalType
  code: string
}

const ApprovalInitMessage: React.FC<ApprovalInitMessageProps> = ({ code, type }) => {
  ...
  return (
    <div className={styles.approval}>
      <div className={styles.title}>{`${APPROVAL_TYPE_TRANSFER[approval.type]}审批申请`}</div>
...
export default ApprovalInitMessage
